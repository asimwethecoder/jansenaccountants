      ...
      <Container>
        <div>
          ...
          <h3 className="text-muted-foreground">
            <Balancer>
              At Jansen Accountants, we provide comprehensive accounting, tax,
              and consulting services tailored to your business needs. Our team
              delivers trusted advice and practical solutions to help you
